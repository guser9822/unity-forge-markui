...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] DwarfNetworkObject = null;
		...
		[Obsolete("Use InstantiateDwarf instead, its shorter and easier to type out ;)")]
		public DwarfBehavior InstantiateDwarfNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(DwarfNetworkObject[index]);
			var netBehavior = go.GetComponent<DwarfBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<DwarfBehavior>().networkObject = (DwarfNetworkObject)obj;
		...
		public DwarfBehavior InstantiateDwarf(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(DwarfNetworkObject[index]);
			var netBehavior = go.GetComponent<DwarfBehavior>();
